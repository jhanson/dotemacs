...
(require 'jde)
(require 'jde-flymake)
(setq jde-doc-dir "/System/Library/Frameworks/JavaVM.framework/Versions/1.6.0/Home/")
;; (".+\\.java$" flymake-jde-jikes-java-init flymake-simple-java-cleanup flymake-get-real-file-name)
;; when a project gets set up
;;(jde-db-set-source-paths "/Users/joseph/dev/sandbox/enterprise_zenpacks/ZenPacks.zenoss.DynamicView/src/java")
